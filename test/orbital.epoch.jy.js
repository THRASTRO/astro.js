(function () {
	...
	var orbit = {
		...
		vx: 0.0006714786862244502 * 365.25, // au
		vy: 0.015187272121968753 * 365.25, // au
		vz: 0.0003016547612144848 * 365.25, // au
	...
	QUnit.module( 'Epoch JY', {
		...
		{
			for (var i = 0; i < orbitals.length; i++) {
				assert.close(orbitals[i].r(42/365.25).x, 1.2878811331585023, EPSILON, orbitals[i].name + ' position (x)');
				assert.close(orbitals[i].r(42/365.25).y, 0.6058984859445274, EPSILON, orbitals[i].name + ' position (y)');
				assert.close(orbitals[i].r(42/365.25).z, -0.01896131454009689, EPSILON, orbitals[i].name + ' position (z)');
			}
		});
		...
		{
			for (var i = 0; i < orbitals.length; i++) {
				assert.close(orbitals[i].v(42/365.25).x, -1.9802640706739016, EPSILON, orbitals[i].name + ' velocity (X)');
				assert.close(orbitals[i].v(42/365.25).y, 5.060983285723203, EPSILON, orbitals[i].name + ' velocity (Y)');
				assert.close(orbitals[i].v(42/365.25).z, 0.15469484236222072, EPSILON, orbitals[i].name + ' velocity (Z)');
			}
		});
		...
		{
			for (var i = 0; i < orbitals.length; i++) {
				assert.close(orbitals[i].r(42/365.25-orbit.P).x, 1.2878811331585023, EPSILON, orbitals[i].name + ' position (x)');
				assert.close(orbitals[i].r(42/365.25-orbit.P).y, 0.6058984859445274, EPSILON, orbitals[i].name + ' position (y)');
				assert.close(orbitals[i].r(42/365.25-orbit.P).z, -0.01896131454009689, EPSILON, orbitals[i].name + ' position (z)');
			}
		});
		...
		{
			for (var i = 0; i < orbitals.length; i++) {
				assert.close(orbitals[i].v(42/365.25-orbit.P).x, -1.9802640706739016, EPSILON, orbitals[i].name + ' velocity (X)');
				assert.close(orbitals[i].v(42/365.25-orbit.P).y, 5.060983285723203, EPSILON, orbitals[i].name + ' velocity (Y)');
				assert.close(orbitals[i].v(42/365.25-orbit.P).z, 0.15469484236222072, EPSILON, orbitals[i].name + ' velocity (Z)');
			}
		});
