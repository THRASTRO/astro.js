(function () {
	...
	QUnit.module( 'Orbitals JY', {
		...
		QUnit.test( 'Mean Motion (n)', function( assert )
		{
			...
			for (var i = 0; i < orbitals.length; i++) {
				assert.close(orbitals[i].n(), 0.00914622550420718 * 365.25, EPSILON, orbitals[i].name);
			}
		});
		...
		{
			for (var i = 0; i < orbitals.length; i++) {
				assert.close(orbitals[i].M(), 0.3378454265824189, EPSILON, orbitals[i].name);
			}
		});
		...
		QUnit.test( 'Orbit Period (P)', function( assert )
		{
			...
			for (var i = 0; i < orbitals.length; i++) {
				assert.close(orbitals[i].P(), 686.9703031364554 / 365.25, EPSILON, orbitals[i].name);
			}
		});
		...
		{
			for (var i = 0; i < orbitals.length; i++) {
				assert.close(orbitals[i].A(), 0.021141156875379624 * 365.25, EPSILON, orbitals[i].name);
			}
		});
		...
		{
			for (var i = 0; i < orbitals.length; i++) {
				assert.close(orbitals[i].B(), 5.1735538133848596851471594798084e-4 * 365.25, EPSILON, orbitals[i].name);
			}
		});
